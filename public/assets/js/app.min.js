...
(function($) {
    ...
    function initLeftMenuCollapse() {
        ...
        $(window).on('load', function() {
            ...
            if (window.innerWidth >= 1024 && window.innerWidth <= 1366) {
                ...
                $('body[data-sidebar-size=sm]').css('min-height', $('#sidebar-menu').outerHeight() + 70);
    ...
    function changeLayout(data){
        axios.post('/theme-options', {data: data}).then(function (response) {})
    }
    function layoutSetting() {
        ...
        $('#mode-setting-btn').on('click', function(e) {
            ...
            if (body.hasAttribute("data-layout-mode") && body.getAttribute("data-layout-mode") == "dark") {
                ...
                document.body.setAttribute('data-topbar', 'light');
                document.body.setAttribute('data-sidebar', 'light');
                changeLayout({'layout_mode':'light',"topbar_color":'light',"sidebar_color":'light'});
            } else {
                ...
                //     document.body.setAttribute('data-sidebar', 'light');
                //     changeLayout({'sidebar_color':'light'});
                // }
                document.body.setAttribute('data-layout-mode', 'dark');
                document.body.setAttribute('data-topbar', 'dark');
                document.body.setAttribute('data-sidebar', 'dark');
                changeLayout({'layout_mode':'dark',"topbar_color":'dark',"sidebar_color":'dark'});
            }
        });
        ...
        $("input[name='layout-direction']").on('change', function() {
            if ($(this).val() == "ltr") {
                ...
                changeLayout({'layout_direction':'ltr'});
            } else {
                ...
                changeLayout({'layout_direction':'rtl'});
            }
        });
    }
